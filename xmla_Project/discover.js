...
exports.getDimensions = function(req,res) {
	...
	var xmlaRequest = {
  		...
  		error:function(){
    		res.write("Error finding the List of Dimensions");
...
//---------------------------------------5. Hierarchies---------------------------------------------
exports.getHierarchies = function(req,res) {
	var X = xmla.Xmla;
	var parameters = req.query.searchParam;
	var xmlaServer = parameters.xmlaServer;
	var pathName = parameters.pathName;
	...
	var xmlaRequest = {
  		...
  		error:function(){
    		res.write("Error finding the List of Hierarchies");
...
exports.getMembers = function(req,res) {
	...
	var xmlaRequest = {
  		...
  		error:function(){
    		res.write("Error finding the List of Members");
